  ...
  return <main className="public-shell">
    ...
    <section className="hero" id="top">
      ...
      <div className="registration-panel">
        ...
        {participant && workshops.length > 0 && <><span className="panel-number">02</span><h2>Olá, {participant.name.split(" ")[0]}! Escolha seu Hands-on</h2><p>Você pode reservar uma única sessão. Confira a sala antes de confirmar.</p></>}
